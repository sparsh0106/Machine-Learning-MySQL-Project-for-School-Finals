...
connect = ms.connect(host = "localhost", user = 'root', passwd = 'bbpsmn@123456', database = 'old_results')
...
def CHECK():
    ...
    predicted_value_label = Label(root, text = f"Value {Y_predict_val[0][0]}", font = ('Corbel 20 bold underline'))
